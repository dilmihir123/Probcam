...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo61to = 1000) int weight, boolean italic, int resultCode) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0094, code lost:
        sBackgroundThread.postAndReply(r2, new android.support.p000v4.provider.FontsContractCompat.C01303());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r9, final android.support.p000v4.provider.FontRequest r10, @android.support.annotation.Nullable final android.support.p000v4.content.res.ResourcesCompat.FontCallback r11, @android.support.annotation.Nullable final android.os.Handler r12, boolean r13, int r14, final int r15) {
        /*
        ...
        L_0x0048:
            ...
            android.support.v4.provider.FontsContractCompat$TypefaceResult r7 = (android.support.p000v4.provider.FontsContractCompat.TypefaceResult) r7     // Catch:{ InterruptedException -> 0x005a }
