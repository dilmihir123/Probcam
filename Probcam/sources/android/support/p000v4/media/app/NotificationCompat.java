...
import android.support.mediacompat.C0009R;
...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0009R.layout.notification_template_media_custom;
            }
        ...
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0009R.layout.notification_template_big_media_narrow_custom : C0009R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0009R.color.notification_material_background_media_default_color);
            }
            views.setInt(C0009R.C0011id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
    ...
    public static class MediaStyle extends Style {
        ...
        public RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0009R.C0011id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0009R.C0011id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0009R.C0011id.end_padder, 8);
                view.setViewVisibility(C0009R.C0011id.cancel_action, 0);
                view.setOnClickPendingIntent(C0009R.C0011id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0009R.C0011id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0009R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0009R.C0011id.end_padder, 0);
                view.setViewVisibility(C0009R.C0011id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0009R.layout.notification_media_action);
            button.setImageViewResource(C0009R.C0011id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0009R.C0011id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0009R.C0011id.action0, action.getTitle());
            }
            return button;
        }
        ...
        /* access modifiers changed from: 0000 */
        public int getContentViewLayoutResource() {
            return C0009R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0009R.C0011id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0009R.C0011id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                big.setViewVisibility(C0009R.C0011id.cancel_action, 0);
                big.setInt(C0009R.C0011id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0009R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0009R.C0011id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0009R.C0011id.cancel_action, 8);
            }
            return big;
        }
        ...
        /* access modifiers changed from: 0000 */
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0009R.layout.notification_template_big_media_narrow : C0009R.layout.notification_template_big_media;
        }
    }
