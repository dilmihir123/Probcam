...
import android.support.compat.C0006R;
...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0006R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0006R.C0008id.actions);
            ...
            if (showActions && this.mBuilder.mActions != null) {
                ...
                if (numActions > 0) {
                    ...
                    for (int i = 0; i < numActions; i++) {
                        remoteViews.addView(C0006R.C0008id.actions, generateActionButton((Action) this.mBuilder.mActions.get(i)));
                    }
                }
            }
            if (!actionsVisible) {
            ...
            remoteViews.setViewVisibility(C0006R.C0008id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0006R.C0008id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0006R.layout.notification_action_tombstone : C0006R.layout.notification_action);
            button.setImageViewBitmap(C0006R.C0008id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0006R.color.notification_action_color_filter)));
            button.setTextViewText(C0006R.C0008id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0006R.C0008id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0006R.C0008id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0006R.C0008id.notification_background, "setBackgroundResource", C0006R.C0007drawable.notification_bg_low);
                    contentView.setInt(C0006R.C0008id.icon, "setBackgroundResource", C0006R.C0007drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0006R.C0008id.notification_background, "setBackgroundResource", C0006R.C0007drawable.notification_bg);
                    contentView.setInt(C0006R.C0008id.icon, "setBackgroundResource", C0006R.C0007drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0006R.C0008id.icon, 0);
                    contentView.setImageViewBitmap(C0006R.C0008id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0006R.C0008id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0006R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0006R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        contentView.setImageViewBitmap(C0006R.C0008id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor()));
                    } else {
                        contentView.setImageViewBitmap(C0006R.C0008id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    contentView.setViewVisibility(C0006R.C0008id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0006R.C0008id.icon, 0);
                if (VERSION.SDK_INT >= 21) {
                    contentView.setImageViewBitmap(C0006R.C0008id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, res.getDimensionPixelSize(C0006R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0006R.dimen.notification_big_circle_margin), res.getDimensionPixelSize(C0006R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    contentView.setImageViewBitmap(C0006R.C0008id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0006R.C0008id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0006R.C0008id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide = VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0006R.C0008id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0006R.C0008id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > res.getInteger(C0006R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(C0006R.C0008id.info, res.getString(C0006R.string.status_bar_notification_info_overflow));
                } else {
                    contentView.setTextViewText(C0006R.C0008id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0006R.C0008id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0006R.C0008id.info, 8);
            }
            if (this.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0006R.C0008id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0006R.C0008id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0006R.C0008id.text2, 0);
                    showLine2 = true;
                } else {
                    contentView.setViewVisibility(C0006R.C0008id.text2, 8);
                }
            }
            if (showLine2 && VERSION.SDK_INT >= 16) {
                if (fitIn1U) {
                    contentView.setTextViewTextSize(C0006R.C0008id.text, 0, (float) res.getDimensionPixelSize(C0006R.dimen.notification_subtext_size));
                }
                contentView.setViewPadding(C0006R.C0008id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (!this.mBuilder.mUseChronometer || VERSION.SDK_INT < 16) {
                    contentView.setViewVisibility(C0006R.C0008id.time, 0);
                    contentView.setLong(C0006R.C0008id.time, "setTime", this.mBuilder.getWhenIfShowing());
                } else {
                    contentView.setViewVisibility(C0006R.C0008id.chronometer, 0);
                    contentView.setLong(C0006R.C0008id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0006R.C0008id.chronometer, "setStarted", true);
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0006R.C0008id.right_side, hasRightSide ? 0 : 8);
            contentView.setViewVisibility(C0006R.C0008id.line3, showLine3 ? 0 : 8);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            int i = C0006R.C0007drawable.notification_icon_background;
            if (color == 0) {
                color = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0006R.C0008id.notification_main_column);
            outerView.addView(C0006R.C0008id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0006R.C0008id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0006R.C0008id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0006R.C0008id.title, 8);
            outerView.setViewVisibility(C0006R.C0008id.text2, 8);
            outerView.setViewVisibility(C0006R.C0008id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            float largeFactor = (constrain(resources.getConfiguration().fontScale, 1.0f, 1.3f) - 1.0f) / 0.29999995f;
            return Math.round(((1.0f - largeFactor) * ((float) resources.getDimensionPixelSize(C0006R.dimen.notification_top_pad))) + (((float) resources.getDimensionPixelSize(C0006R.dimen.notification_top_pad_large_text)) * largeFactor));
        }
