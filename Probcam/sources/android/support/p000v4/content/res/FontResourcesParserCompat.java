...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0006R.styleable.FontFamily);
        String authority = array.getString(C0006R.styleable.FontFamily_fontProviderAuthority);
        String providerPackage = array.getString(C0006R.styleable.FontFamily_fontProviderPackage);
        String query = array.getString(C0006R.styleable.FontFamily_fontProviderQuery);
        int certsId = array.getResourceId(C0006R.styleable.FontFamily_fontProviderCerts, 0);
        int strategy = array.getInteger(C0006R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int timeoutMs = array.getInteger(C0006R.styleable.FontFamily_fontProviderFetchTimeout, DEFAULT_TIMEOUT_MILLIS);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0006R.styleable.FontFamilyFont);
        int weight = array.getInt(array.hasValue(C0006R.styleable.FontFamilyFont_fontWeight) ? C0006R.styleable.FontFamilyFont_fontWeight : C0006R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        if (1 != array.getInt(array.hasValue(C0006R.styleable.FontFamilyFont_fontStyle) ? C0006R.styleable.FontFamilyFont_fontStyle : C0006R.styleable.FontFamilyFont_android_fontStyle, 0)) {
            isItalic = false;
        }
        int resourceAttr = array.hasValue(C0006R.styleable.FontFamilyFont_font) ? C0006R.styleable.FontFamilyFont_font : C0006R.styleable.FontFamilyFont_android_font;
